...
<script src="<%=request.getContextPath() %>/filemanage/law_file/updateLaw.js"></script> 
...
<div style="height: 13%;" id="headerDiv">
	<div class="header-content">
			<h2>
				...
				<c><a style="text-decoration: none;" href="law_file.jsp">执法文案</a>
				<span style="margin-left: 5px;margin-right: 5px;">></span>修改执法文件</c>
			</h2>
	</div>
</div>
	       ...
	       <input type="hidden"  value=""   name="uuid"  id="uuid">
			...
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					<button id="insert1LawProject"  type="button" class="btn btn-default btns btnEdit" style="background-color: #009f95;border: 0px;color:#fff;width: 80px;height: 40px;border-radius: 10px;text-align:center;">&nbsp;保&nbsp;存</button>
				</div>
			</div>
	  </form>
</div>