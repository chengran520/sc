...
<script src="<%=request.getContextPath() %>/filemanage/systemFile/updateSystem.js"></script> 
	...
	<form class="form-horizontal" role="form" id="form_file">
			<div class="form-group">
				...
				<div class="col-sm-2">
				   <select class="form-control" name="fileType" id="fileType">
		      	      <option value="0">考核制度</option>
	      	          <option value="1">巡检制度</option>
	      	          <option value="2">保洁制度</option>
		           </select>	
				</div>
			</div>
			<div class="form-group">
		        ...
		        <div  id="star"  class="col-sm-5" style="display:none;margin-top: 13px;">
				                评星：
					  <a  style="color:#999999;"><span  id="star_first"  class="glyphicon glyphicon-star-empty" aria-hidden="true" style="font-size:18px;"></span></a>
					  <a  style="color:#999999;"><span id="star_second" class="glyphicon glyphicon-star-empty" aria-hidden="true" style="font-size:18px;"></span></a>
					  <a  style="color:#999999;"><span id="star_third"  class="glyphicon glyphicon-star-empty" aria-hidden="true" style="font-size:18px;"></span></a>
					  <a  style="color:#999999;"><span id="star_fourth" class="glyphicon glyphicon-star-empty" aria-hidden="true" style="font-size:18px;"></span></a>
					  <a  style="color:#999999;"><span id="star_fifth"   class="glyphicon glyphicon-star-empty" aria-hidden="true" style="font-size:18px;"></span></a>
		        </div> 
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					<button  id="save1File"  type="button" class="btn btn-default btns btnEdit" >&nbsp;保&nbsp;存</button>
				</div>
			</div>
	  </form>
