var mapMroe={
		addRiverOpen:function(){
			...
			count += "<img src='"+WEB_ROOT+"/gis_map/images/river_lt/sc_lt1.jpg'  class='tab-pane-img'>";
			count += "<img src='"+WEB_ROOT+"/gis_map/images/river_lt/sc_lt2.jpg'  class='tab-pane-img'>";
			count += "<img src='"+WEB_ROOT+"/gis_map/images/river_lt/sc_lt3.jpg'  class='tab-pane-img'>";
			count += "<img src='"+WEB_ROOT+"/gis_map/images/river_lt/sc_lt4.jpg'  class='tab-pane-img'>";
			count += "<img src='"+WEB_ROOT+"/gis_map/images/river_lt/sc_lt5.jpg'  class='tab-pane-img'>";
			count += "<img src='"+WEB_ROOT+"/gis_map/images/river_lt/sc_lt6.jpg'  class='tab-pane-img'>";
			count += "</section>";
			count += "</div>";		
