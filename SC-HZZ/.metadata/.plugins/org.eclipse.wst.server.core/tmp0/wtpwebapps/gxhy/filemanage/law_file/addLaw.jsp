...
<script src="<%=request.getContextPath() %>/filemanage/law_file/addLaw.js"></script> 
...
<div style="height: 13%;" id="headerDiv">
	<div class="header-content">
			<h2>
				...
				<span style="margin-left: 5px;margin-right: 5px;">></span>添加执法文案</c>			
			</h2>
	</div>
</div>
<div style="margin-top:10px;overflow-x:hidden; overflow-y:auto;" class="content">
	<form class="form-horizontal" role="form" id="form_project">
			<input class="form-control" name="fileType" id="fileType" type="hidden" value="02">
...
<!-- 			<div class="form-group">
			...
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					<button id="saveLawProject"  type="button" class="btn btn-default btns btnEdit" >&nbsp;保&nbsp;存</button>
				</div>
			</div>
	  </form>
</div>