...
<script src="<%=request.getContextPath() %>/filemanage/law_file/law_file.js"></script> 
			...
			<div style="padding: 10px;border-bottom: 1px solid #dddddd;">
				<div class="col-xs-2.2" style="display: inline;">
					<div class="input-group">
					  ...
					  <input type="text" class="form-control" id="keyword"  placeholder="请输入文案名称">
					</div>
				</div>
				<!-- <div class="col-xs-2.2" style="display: inline; ">
					<div class="input-group">
...
<!--列表  -->
<table id="patrol_law"  style="text-overflow:ellipsis;">
	<thead>
		<tr> 
		   <th field="uuid" hidden="true" width="1">主那家</th>
            <th field="projectName" width="30" align="center" align="center">项目名称</th>
            ...
            <th field="endTime" width="20" align="center" >结束时间</th> -->
             <th field="creatTime" width="20" align="center" formatter="LawFile.formatterCreateTm">创建时间</th>
            <th field="operation" width="30"  align="center" formatter="LawFile.formatLawOperation">操作</th>
		</tr>
	</thead>
</table>
