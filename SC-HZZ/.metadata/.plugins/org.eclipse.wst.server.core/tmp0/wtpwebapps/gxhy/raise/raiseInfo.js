var raiseInfo={
	initEventData:function(){
			...
			easyui_datagrid_util.create_datagrid_options("raise", WEB_ROOT+ "/event/riverCourse/getRiverCourses?type=4",raiseInfo,null);
	},
...
$(function(){
	...
	$("#raise").height(height - 40);
	raiseInfo.initEventData();
	var data=raiseInfo.getPieEvent();
	raiseInfo.echartsPieEvent(data);
});